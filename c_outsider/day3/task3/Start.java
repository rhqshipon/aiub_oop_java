public class Start {
	public static void main(String[] args) {
		...
		System.out.println("\n--- Demonstrating addQuantity and sellQuantity ---");
		System.out.println("Initial quantity of " + sb1.getBookTitle() + ": " + sb1.getAvailableQuantity());
		sb1.addQuantity(5);
		System.out.println("After adding 5: " + sb1.getAvailableQuantity());
		sb1.sellQuantity(3);
		System.out.println("After selling 3: " + sb1.getAvailableQuantity());
